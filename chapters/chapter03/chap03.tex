...
\begin{figure}[H]
\centering
% \includegraphics[width=0.85\textwidth]{votre_chemin/image_datalake.png}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.85\textwidth]{votre_chemin/image_cicd.png}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.9\textwidth]{votre_chemin/diagramme_use_case.png}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.9\textwidth]{votre_chemin/architecture_logique.png}
...
% % 🛠️ À FAIRE : Insérer l'Architecture Logique
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.9\textwidth]{chapters/chapter03/fig03/2-7-architecture_logique.png}
%     %\rule{0.9\textwidth}{7cm} % Ligne à supprimer quand l'image sera insérée
%     \caption{Architecture logique du pipeline MLOps}
%     \label{fig:architecture_logique}
% \end{figure}
...
\begin{figure}[H]
\centering
% \includegraphics[width=0.95\textwidth]{votre_chemin/architecture_physique_aws.png}
