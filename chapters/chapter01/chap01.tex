...
\section*{MÉTHODOLOGIE ET STRUCTURE DU MÉMOIRE}
Pour atteindre ces objectifs, nous avons adopté une démarche méthodologique structurée comme suit :
\begin{itemize}
    \item[$\bullet$] Effectuer une revue de la littérature afin d'assimiler l'état de l'art, de cerner les concepts clés du Cloud et du MLOps, et de définir précisément les contours du projet ;
    \item[$\bullet$] Réaliser l'analyse des besoins fonctionnels et non fonctionnels afin de délimiter le périmètre du système ;
    \item[$\bullet$] Modéliser théoriquement les architectures logique et physique de la solution ;
    \item[$\bullet$] Implémenter la solution sur l'infrastructure AWS et élaborer un protocole d'expérimentation pour valider les performances obtenues.
\end{itemize}

\vspace{1.5mm}
Le présent travail est structuré en trois chapitres principaux :

Le Chapitre 1, intitulé \textbf{Généralités et état de l'art}, introduit les fondements du MLOps et du Cloud Computing, leurs fonctionnalités ainsi que leurs enjeux juridiques et sécuritaires. Il dresse une revue rigoureuse de la littérature scientifique récente et propose une analyse comparative des architectures MLOps industrielles de référence afin de justifier scientifiquement notre positionnement d'ingénierie.

Le Chapitre 2, consacré à la \textbf{Méthodologie de conception}, détaille l'analyse approfondie de la problématique et expose la démarche à travers la présentation des architectures logique et physique de la solution.

Le Chapitre 3, intitulé \textbf{Implémentation, résultats et discussion}, décrit l'environnement d'exécution ainsi que le déploiement effectif de l'infrastructure sur AWS. Il présente ensuite l'analyse des résultats expérimentaux, en évaluant les performances globales de l'architecture, sa capacité de passage à l'échelle et son efficacité FinOps. 

Enfin, une conclusion générale récapitule les contributions de ce travail, en soulignant ses limites et en ouvrant des perspectives d'évolution pour des recherches futures.