...
\begin{itemize}[label=\ding{42}, font=\large \color{darkgreen}]
    ...
    Dans ce chapitre, nous présentons dans un premier temps des généralités structurées autour de deux axes : le MLOps (son importance, sa méthodologie, ses défis et son cycle de vie) et le Cloud Computing (ses fonctions et ses limites juridiques et sécuritaires). Dans un second temps, nous dressons un état de l'art comparatif des grandes plateformes Cloud et des architectures MLOps existantes. Pour finir, nous faisons un bilan afin de positionner notre démarche.
    \vspace{2mm}
