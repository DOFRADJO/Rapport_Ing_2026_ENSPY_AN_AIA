...
% \renewcommand{\tocheadstart}{\chapter*{TABLE OF CONTENTS}}
%
%
% Adding metadata:
...
\definecolor{darkgreen}{RGB}{220,135,0}
...
% \usepackage[backend=biber,style=authoryear,sorting=nyt, sorting=none]{biblatex}
...
\usepackage[backend=biber,style=numeric,sorting=none,sortcites=true,maxbibnames=5,doi=false,url=true,eprint=false]{biblatex}
\addbibresource{chapters/biblio/biblio.bib}
...
\newcommand{\myrowcolour}{\rowcolor[darkgreen]{0.925}}
...
\newcommand{\corner}[1]{%
  \begin{tikzpicture}[color=darkgreen,remember picture, overlay]
...
%
\AtBeginDocument{\renewcommand{\bibname}{Bibliographical References }}
\AtBeginDocument{\renewcommand{\refname}{Bibliographical References}}
...
%\addtocontents{toc}{\hspace{-0.60cm}{\bf } \nobreak \mbox{}\hfill{\bf }\par\nobreak}
%\addtocontents{toc}{\hspace{-0.60cm}{\bf Table de Matières} \nobreak %\mbox{}\hfill{\bf xi}\par\nobreak}
...
% --- Ajout ici avant figures/tables ---
...
\clearemptydoublepage 
%\import{chapters/biblio/}{biblio.tex}
% \glsaddall
%\nocite{*}
