...
\vspace{3mm}
{\normalsize \textbf{Dr Austin WAFFO}, Assistant chargé de cours , UYI/ENSPY} \\
\vspace{3mm}
...
{\large Examinateur:} {\normalsize \textbf{Dr X}, Assistant chargé de cours, UYI/ENSPY} \\[3mm]

{\large Rapporteur 1 :} {\normalsize \textbf{Pr Thomas BOUETOU BOUETOU}, Professeur, UYI/ENSPY} \\[3mm]

{\large Rapporteur 2 :} {\normalsize \textbf{Dr Austin WAFFO}, Assistant chargé de cours , UYI/ENSPY} \\[3mm]
...
% \vspace{4mm}
{\large \textcolor{darkgray}{Mémoire soutenu en Septembre 2026}}
\end{tabular}
